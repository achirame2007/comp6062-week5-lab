...
console.log('isGreaterThan(a > b):',isGreaterThan);

// Example: let isGreaterOrEqual;
// Check if 'a' is greater than or equal to 'b'.
let isGreaterOrEqual = (a >= b);
console.log('isGreaterOrEqual(a >= b):',isGreaterOrEqual);

// Example: let isLessThan;
// Check if 'a' is less than 'b'.
let isLessThan = (a < b);
console.log('isLessThan(a < b):',isLessThan);

// Example: let isLessOrEqual;
// Check if 'a' is less than or equal to 'b'.
let isLessOrEqual = (a <= b);
console.log('isLessOrEqual(a <= b):',isLessOrEqual);
